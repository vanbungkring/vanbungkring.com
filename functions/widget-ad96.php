...
function tz_Ad_Widget() {
	...
	$widget_ops = array (
		...
		'description' => __('A widget that allows the display and configuration of 6 96x96 ads blocks.', 'framework')
	);
	...
	// Create the widget
	$this->WP_Widget( 'tz_ad_widget', __('Custom 96x96 Ads', 'framework'), $widget_ops, $control_ops );
...
function widget( $args, $instance ) {
	...
	echo '<div class="ads-96 clearfix">';

	// Display Ad 1
	if ( $link1 )
		$ads[] = '<a href="' . $link1 . '"><img src="' . $ad1 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad1 )
	 	$ads[] = '<img src="' . $ad1 . '" width="96" height="96" alt="" />';
	
	// Display Ad 2
	if ( $link2 )
		$ads[] = '<a href="' . $link2 . '"><img src="' . $ad2 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad2 )
	 	$ads[] = '<img src="' . $ad2 . '" width="96" height="96" alt="" />';
		
	// Display Ad 3
	if ( $link3 )
		$ads[] = '<a href="' . $link3 . '"><img src="' . $ad3 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad3 )
	 	echo '<img src="' . $ad3 . '" width="96" height="96" alt="" />';
		
	// Display Ad 4
	if ( $link4 )
		$ads[] = '<a href="' . $link4 . '"><img src="' . $ad4 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad4 )
	 	$ads[] = '<img src="' . $ad4 . '" width="96" height="96" alt="" />';
		
	// Display Ad 5
	if ( $link5 )
		$ads[] = '<a href="' . $link5 . '"><img src="' . $ad5 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad5 )
	 	$ads[] = '<img src="' . $ad5 . '" width="96" height="96" alt="" />';
		
	// Display Ad 6
	if ( $link6 )
		$ads[] = '<a href="' . $link6 . '"><img src="' . $ad6 . '" width="96" height="96" alt="" /></a>';
		
	elseif ( $ad6 )
	 	$ads[] = '<img src="' . $ad6 . '" width="96" height="96" alt="" />';
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_template_directory_uri()."/images/banner-96x96.gif",
		'link1' => 'http://www.ihatepixels.com',
		'ad2' => '',
		'link2' => '',
		'ad3' => '',
		'link3' => '',

			...
			<div class="page clearfix">
				...
				<!--BEGIN .contact-form -->
							...
							<?php if(isset($emailSent) && $emailSent == true) { ?>
                                    ...
                                    <p class="thanks"><?php _e('Thanks, your email was sent successfully.', 'framework') ?></p>
                            </div>   
                                ...
                                <form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                                    <ul class="contactform">
                                        ...
                                        <li class="textarea"><label for="commentsText"><?php _e('Message:', 'framework') ?></label>
                                            <textarea name="comments" id="commentsText" rows="10" cols="20" class="required requiredField"><?php if(isset($_POST['comments'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['comments']); } else { echo $_POST['comments']; } } ?></textarea>
                                            <?php if($commentError != '') { ?>
